...
import com.codefans.opensource.redis.RedisContext;
...
public abstract class JedisClusterCommand<T> {
    ...
    public void setRedisAddr(Jedis jedis) {
        Client client = jedis.getClient();
        RedisContext.setAddr(client.getHost() + ":" + client.getPort());
    }
