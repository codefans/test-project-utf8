package com.codefans.opensource.redis.exfromnet01;
...
public class RedisTest {
    ...
    @Before
    public void before(){
        String addr = "10.60.58.165:7000";
        String pass = "Lsjrxd";

        String[] serverArray = addr.split(",");
        ...
        jedisCluster = new JedisCluster(nodes, 1000, 1000, 1, pass, new GenericObjectPoolConfig());
