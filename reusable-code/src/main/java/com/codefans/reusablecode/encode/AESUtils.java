...
public class AESUtils {
     ...
     * 密钥
     */
//    private static final String KEY = "d2d!56!8#=6h4g2d";// AES加密要求key必须要128个比特位（这里需要长度为16，否则会报错）
    private static final String KEY = "LQp8ANg2S3ROPjWZ";// AES加密要求key必须要128个比特位（这里需要长度为16，否则会报错）
