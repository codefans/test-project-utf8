...
//        System.exit(0);
        ...
        for(int i = 0; i < defaultUnitPrices.length; i ++) {
            priceSum = this.add(priceSum, this.multiply(defaultUnitPrices[i], weights[i]));
        }
...
//                System.out.println("total: " + total + ", addedUnitPrice:" + this.add(defaultUnitPrices[i], multiSteps) + ", multiSteps:" + multiSteps + ", finalSum:" + this.getTotalPriceAfterAddedUnitPrice(multiSteps, i, defaultUnitPrices, weights) + ", loopTimes:" + loopTimes + ", i:" + i);
                ...
                System.out.println("total=" + total + ", maxUnitPrice=" + maxUnitPrice);
                run = false;
            }
...
//        super.printResult(minMultiSteps, defaultUnitPrices, weights);
    ...
    public void multiTask() {
        ...
        List<Boolean> toSortList = this.getIfSortList("last", toSortElementCount);
...
//                this.printResult(null, result.getUnitPriceList().toArray(new BigDecimal[]{}), result.getWeightList().toArray(new BigDecimal[]{}));
                ...
                String excelPath = rootDir + File.separator + "output_result_" + System.currentTimeMillis() + ".xlsx";
                System.out.println(rootDir);
