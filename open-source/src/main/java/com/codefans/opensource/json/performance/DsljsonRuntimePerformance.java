...
//            System.out.println(deser.integers);
//            System.out.println(deser.map);
//
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
...
//            dataMap.put("intKey", 123);
//            dataMap.put("longKey", 3454L);
//            dataMap.put("strKey", "strValue");
//
//            ByteArrayOutputStream baos = new ByteArrayOutputStream();
//            writer.toStream(baos);
//
//            dslJson.serialize(dataMap, baos);
//
//            byte[] bytes = baos.toByteArray();
//            System.out.println("serializeStr: " + new String(bytes, "UTF-8"));
//
//            ByteArrayInputStream bais = new ByteArrayInputStream(bytes);
//
//            Map<String, Object> deserialMap = dslJson.deserialize(Map.class, bais);
//            System.out.println(deserialMap.get("intKey"));
//            System.out.println(deserialMap.get("longKey"));
//            System.out.println(deserialMap.get("strKey"));
//
//
//        } catch (IOException e) {
//            e.printStackTrace();
