...
package com.codefans.opensource.fescar.official.starter;

//import com.alibaba.fescar.samples.dubbo.ApplicationKeeper;
import com.codefans.opensource.fescar.official.ApplicationKeeper;
...
public class DubboAccountServiceStarter {
    ...
    public static void main(String[] args) {
        ClassPathXmlApplicationContext accountContext = new ClassPathXmlApplicationContext(new String[]{"fescar/dubbo-account-service.xml"});
