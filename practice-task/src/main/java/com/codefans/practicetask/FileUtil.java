...
//				System.out.println(str);
	...
	public void compareFile(String sourceFilePath, String destFilePath) {
		...
		List<String> sourceList = this.fileToList(sourceFilePath, true);
		List<String> destList = this.fileToList(destFilePath, true);
...
//		print(result);
	...
	public List<String> fileToList(String filePath) {
		return this.fileToList(filePath, true);
	}

	public List<String> fileToList(String filePath, boolean filterBlankLine) {
