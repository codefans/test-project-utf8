 ...
 */
public class BloomFilterUsingJava {
    ...
    public BloomFilterUsingJava(String path){
        /**
         *  给出所有的hash值，共计seeds.length个hash值。共8位。
         *  通过调用SimpleHash.hash(),可以得到根据8种hash函数计算得出hash值。
         *  传入DEFAULT_SIZE(最终字符串的长度），seeds[i](一个指定的质数)即可得到需要的那个hash值的位置。
    ...
    public void initFromProgram(int initCount){
    ...
    public static void main(String[] args) {
        BloomFilterUsingJava bloomFilterTest = new BloomFilterUsingJava("e:/test.txt");
